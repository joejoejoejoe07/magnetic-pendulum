...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof exportButton")).define("viewof exportButton", ["html"], _exportButton);
  main.variable(observer("exportButton")).define("exportButton", ["Generators", "viewof exportButton"], (G, _) => G.input(_));
